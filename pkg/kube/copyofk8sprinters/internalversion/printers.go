...
func printReplicationController(obj *api.ReplicationController, options printers.GenerateOptions) ([]metav1.TableRow, error) {
	...
	desiredReplicas := int32(1) // spec default
	if specReplicas != nil {
...
func loadBalancerStatusStringer2(s networking.IngressLoadBalancerStatus, wide bool) string {
	ingress := s.Ingress
...
func printIngress(obj *networking.Ingress, options printers.GenerateOptions) ([]metav1.TableRow, error) {
	...
	address := loadBalancerStatusStringer2(obj.Status.LoadBalancer, options.Wide)
